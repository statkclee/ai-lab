...
> ## 학습 목표 {.objectives}
>
> * 선사시대 이래로 불평등의 기원에 대해서 살펴보고, 향후 발생할 불평등의 원인에 대해서도 생각해 본다.
> * 지난 10년간의 변화와 10년간의 변화 기저에 흐르는 패러다임 전환을 이해한다.
> * 데이터 과학과 기계와의 경쟁에 대해 이해하고, 데이터 과학 사용법을 살펴본다.

### 0. 총, 균, 그리고 강철

> ### KBS 다큐멘터리  {.prereq}
> |     1부 (에덴동산 밖으로)    |     2부 (정복)     |     3부 (열대 속으로)    | 
> |:--------------------------------:|:--------------------------------:|:--------------------------------:|
> | <iframe width="250" height="160" src="https://www.youtube.com/embed/aarWkdS-dJ0?list=PLfev1D5jxnQhL5_u0ZsyblAc12N19Tlaz" frameborder="0" allowfullscreen></iframe> | <iframe width="250" height="160" src="https://www.youtube.com/embed/rkupQU2aJpE?list=PLfev1D5jxnQhL5_u0ZsyblAc12N19Tlaz" frameborder="0" allowfullscreen></iframe> | <iframe width="250" height="160" src="https://www.youtube.com/embed/EPo5hW1We1g?list=PLfev1D5jxnQhL5_u0ZsyblAc12N19Tlaz" frameborder="0" allowfullscreen></iframe> |

<총, 균 그리고 쇠(Guns, Germs, and Steel)>는 재러드 다이아몬드 교수가 거의 평생을 바쳐 연구한 결과를 책 한권으로 정리한 것으로 한국어 번역판은 700쪽에 달하고, 모든 이들의 최근 1만 3천 년간의 짧은 역사(A short history about everyone for the last 13,000 years)'라는 부제가 붙어 있다. 유라시아 문명이 다른 문명을 정복할 수 있었던 이유는 유라시아 인종의 지적, 도덕적, 유전적 우월성 때문이 아니라, 지리적 차이 때문이라는 결론을 주장하고 있다. 

톨스토이 소설 안나 카레리나에 있는 "행복한 가정은 모두 엇비슷하고 불행한 가정은 불행한 이유가 제각기 다르다" 라는 문구와 연관하여 '총, 균 그리고 쇠'를 읽어보면 이해에 도움이 된다. 선사시대부터 시작된 지리적 차이가 농업 생산성의 차이를 야기하고 이것이 기술의 차이로 확대 재생산 되어 결국 지금과 같은 불평등이 양산되었다. 

세부적으로 들어가면, 선사시대 수렵채집하던 인류가 어떤 이유에선가 정착을 하면서 농업을 시작하였는데, 단위 면적에서 가장 많은 칼로리를 생산해 낼 수 있는 밀과 보리가 있었던 비옥한 초승달 지역에서 성공적인 정착생활이 가능했고, 수백만종의 포유류 중에서 가축으로 길들여 노동력(소,말)과 전투(말)에 사용되면서 고기와 우유로 단백질을 공급할 수 있게 되면서 두가지 혁신적인 무기를 추가로 갖게 되는데 이것이 세균과 강철이다. 세균은 사람이 가축과 함께 잠을 자고, 우유와 고기로 섭취를 하면서 자연스럽게 전염되고 이를 이겨낸 사람만이 수천년 동안 생존하면서 그렇지 못한 민족 즉, 신대륙 문명에는 없는 파괴적인 무기로 유라시아 및 아프리카 사람이 갖게 되었고, 단위 농업생산량이 증가하면서 잉여가 생겨나고 이를 통한 기술 혁식을 이뤄 강철을 만들어 내게 되었다. 

즉, 비옥한 초승달 지역에서 시작한 농업문명은 동일한 위도에 위치한 유럽과 아시아로 확대 재생산하여 나가게 되고, 지구 남반부에도 동일하게 남회귀선을 중심으로 밀, 가축으로 상징되는 유럽문명을 전파해 나갈 수 있었다. 하지만, 아프리카 열대 지방에는 이러한 성공방정식이 적용되지 않는데, 이유는 밀과 가축으로 상징되는 비옥한 초승달 지역에서 적용되는 방식이 아프리카 열대지역에는 토양이 달라 밀, 보리 등 농사가 되지 않고, 가축이 말라리아 등 아프리카 토착균에 인간을 비롯하여 적응이 되지 않아 실패하고 만다. 

결국, 총, 균, 그리고 강철로 상징되는 성공방정식이 단순히 "산업혁명"의 성공으로 유럽이 지금의 전세계적인 불평등을 만들었다는 설명보다 보다 설득력 있고 유의미한 해석을 제시하고 있다. 그럼 이것과 더불어 현재의 불평등은 어떻게 설명할 수 있을까?
...
<img src="fig/ai-lab-sandwich-korea.png" alt="샌드위치 대한민국" width="57%" />
...
<img src="fig/ai-lab-ct-4th-paradigm.png" alt="3가지 사고체계와 4번째 패러다임" width="70%" />
...
[^korea-knowledge]: [Suh, Joonghae, and Derek HC Chen, eds. Korea as a knowledge economy. World Bank Group, 2007.](https://openknowledge.worldbank.org/handle/10986/6755)

<img src="fig/ai-lab-korea-science.png" alt="대한민국 과학기술" width="70%" />

#### 3.2. 과학기술의 진화 [^grey-4th-paradigm]

[^grey-4th-paradigm]: [Hey, Tony, Stewart Tansley, and Kristin M. Tolle. The fourth paradigm: data-intensive scientific discovery. Vol. 1. Redmond, WA: Microsoft research, 2009.](http://202.120.81.220:81/inter/uploads/readings/four-paradigm.pdf)
...
<img src="fig/ai-lab-4th-paradigm.png" alt="과학기술의 4번째 패러다임" width="87%" />

### 4. 데이터 과학 사용법

뮤오리진 등 디지털 콘텐츠를 개발하는데 상당한 소프트웨어 기술이 필요하다. 하지만 MMORPG 온라인 디지털 콘텐츠는 다른 디지털 콘텐츠와 비교하여 훨씬 더 많은 양질의 데이터를 뿜어내고 있다.
하지만, 전통적인 RDBMS, 엑셀로 대표되는 스프레드쉬트 아키넥처를 가지고 이를 해결해 내는 것은 쉽지 않다.
우선, 엄청난 양의 데이터와 다양한 데이터를 RDBMS가 담아내기가 쉽지 않다. 이유는 RDBMS가 이런 목적으로 처음에 만들어진 것이 아니기 때문이다. 
...
<img src="fig/ai-lab-data-science-process.png" alt="데이터 과학 프로세스" width="67%" />
