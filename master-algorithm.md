...
## 1. 궁극의 주인이 될 알고리즘 (Master Algorithm) [^master-algorithm-google-talk]
...
<img src="fig/programming_machine_learning_comparison.png" alt="프로그래밍과 기계학습 비교" width="37%" />

### 1.2. 프로그램을 개발하는 컴퓨터 [^slate-news-article]
...
<img src="fig/symbolist-robot-scientiest-eve.jpg" alt="로봇 과학자 이브" width="47%">
...
<img src="fig/neural_network_framework.png" alt="신경망" width="57%">
...
<img src="fig/google-cat-network-deep-neural-network.png" alt="구글 고양이 딥 뉴럴 네트워크" width="37%">
...
<img src="fig/genetic-algorithm.gif" alt="유전자 알고리즘" width="37%">
...
<img src="fig/genetic-programming.png" alt="유전자 프로그래밍" width="37%">
...
<img src="fig/autonomous_vehicle.jpg" alt="자율주행 자동차" width="55%">
...
<img src="fig/knn.png" alt="최근접 이웃 알고리즘" width="35%">

#### 2.5.2. 커널 기계(Kernel Machine) - SVM

<img src="fig/svm.png" alt="SVM" width="35%">
