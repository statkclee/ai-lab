...
경쟁자를 알수 없는 무한 경쟁 시대에 새롭운 강자로 등장한 기계, 즉 [인공지능](http://www.aistudy.co.kr/)을 학습함으로써 **데이터 과학, 기계학습, 인공지능** 에 대한 짧은 기간이나마 경험을 통해 남은 삶을 기계와 공존할 수 있는 방안을 모색한다.
...
* 서강대학교(MOTA404) - 인공지능과 머신러닝
    ...
    * [융복합기술사업화특론 - 데이터과학과 머신러닝 입문/응용(2018)](slideshow/mota-2018-reveal-js.html)
...
- [데이터 과학을 위한 저작 도구](https://statkclee.github.io/ds-authoring/)
